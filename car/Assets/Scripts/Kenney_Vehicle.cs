...
public class Kenney_Vehicle : MonoBehaviour{
	...
	[Range(5.0f, 250.0f)] public float acceleration = 30f;
	...
	void OnTriggerEnter(Collider other){
		...
		if(other.GetComponent<Kenney_PhysicsObject>())
        {
            other.GetComponent<Kenney_PhysicsObject>().Hit(sphere.velocity);
        }
